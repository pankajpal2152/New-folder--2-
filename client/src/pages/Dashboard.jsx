    ...
    <div style={styles.container}>
      <div style={styles.topGrid}>
        ...
        <StatCard
          ...
          isPositive={true}
          iconEmoji="⏱️"
          iconBgColor="rgba(113, 221, 55, 0.16)"
          iconColor="#71dd37"
        />
        <StatCard
          title="Sales"
          ...
          isPositive={true}
          iconEmoji="💳"
          iconBgColor="rgba(3, 195, 236, 0.16)"
          iconColor="#03c3ec"
        />
      </div>
      ...
      <div style={styles.middleGrid}>
        ...
        <div style={styles.rightSideGrid}>
          <StatCard
            ...
            isPositive={false}
            iconEmoji="💸"
            iconBgColor="rgba(255, 62, 29, 0.16)"
            iconColor="#ff3e1d"
          />
          <StatCard
            title="Transactions"
            ...
            isPositive={true}
            iconEmoji="💳"
            iconBgColor="rgba(105, 108, 255, 0.16)"
            iconColor="#696cff"
          />
          <ProfileReportCard />
        </div>
      ...
      <footer style={styles.footer}>
        <div>
          © 2026 , made with ❤️ by{" "}
          <span style={{ fontWeight: "600", color: "#566a7f" }}>
            Pankaj Pal
          </span>
        </div>
        <div style={{ display: "flex" }}>
          <a href="#license" style={styles.footerLink}>
            License
          </a>
